...
/*
Package bkjournal is a generated protocol buffer package.
...
type VersionProto struct {
	...
	NamespaceInfo    *hadoop_hdfs1.NamespaceInfoProto `protobuf:"bytes,2,opt,name=namespaceInfo" json:"namespaceInfo,omitempty"`
...
func (m *VersionProto) GetNamespaceInfo() *hadoop_hdfs1.NamespaceInfoProto {
	if m != nil {
...
func init() { proto.RegisterFile("bkjournal.proto", fileDescriptor0) }
