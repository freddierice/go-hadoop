...
func (EventType) EnumDescriptor() ([]byte, []int) { return fileDescriptor17, []int{0} }
...
func (INodeType) EnumDescriptor() ([]byte, []int) { return fileDescriptor17, []int{1} }
...
func (MetadataUpdateType) EnumDescriptor() ([]byte, []int) { return fileDescriptor17, []int{2} }
...
func (*EventProto) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{0} }
...
func (*EventBatchProto) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{1} }
...
func (*CreateEventProto) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{2} }
...
func (*CloseEventProto) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{3} }
...
func (*TruncateEventProto) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{4} }
...
func (*AppendEventProto) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{5} }
...
func (*RenameEventProto) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{6} }
...
func (*MetadataUpdateEventProto) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{7} }
...
func (*UnlinkEventProto) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{8} }
...
func (*EventsListProto) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{9} }
...
func init() { proto.RegisterFile("inotify.proto", fileDescriptor17) }
