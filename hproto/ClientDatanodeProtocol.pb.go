...
func (*RefreshNamenodesRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{2} }
...
func (*RefreshNamenodesResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{3} }
...
func (*DeleteBlockPoolRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{4} }
...
func (*DeleteBlockPoolResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{5} }
...
func (*ShutdownDatanodeRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{8} }
...
func (*ShutdownDatanodeResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{9} }
...
func (*EvictWritersRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{10} }
...
func (*EvictWritersResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{11} }
...
func (*GetDatanodeInfoRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{12} }
...
func (*GetDatanodeInfoResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{13} }
...
func (*TriggerBlockReportRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{14} }
...
func (*CancelPlanRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{20} }
...
func (*CancelPlanResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{21} }
...
func (*QueryPlanStatusRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{22} }
...
func (*QueryPlanStatusResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{23} }
...
func init() { proto.RegisterFile("ClientDatanodeProtocol.proto", fileDescriptor2) }
