...
func (RpcKindProto) EnumDescriptor() ([]byte, []int) { return fileDescriptor12, []int{0} }
...
func (RpcSaslProto_SaslState) EnumDescriptor() ([]byte, []int) { return fileDescriptor12, []int{4, 0} }
...
func (*RPCTraceInfoProto) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{0} }
...
func (*RPCCallerContextProto) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{1} }
...
func (*RpcRequestHeaderProto) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{2} }
...
func (*RpcResponseHeaderProto) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{3} }
...
func (*RpcSaslProto) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{4} }
...
func (*RpcSaslProto_SaslAuth) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{4, 0} }
...
func init() { proto.RegisterFile("RpcHeader.proto", fileDescriptor12) }
