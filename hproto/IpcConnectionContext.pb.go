...
func (*UserInformationProto) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0} }
...
func (*IpcConnectionContextProto) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{1} }
...
func init() { proto.RegisterFile("IpcConnectionContext.proto", fileDescriptor6) }
