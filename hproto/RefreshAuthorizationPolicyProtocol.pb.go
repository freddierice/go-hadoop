...
func (*RefreshServiceAclRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{0} }
...
func (*RefreshServiceAclResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{1} }
...
func init() { proto.RegisterFile("RefreshAuthorizationPolicyProtocol.proto", fileDescriptor9) }
