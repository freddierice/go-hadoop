...
func (*CedeActiveRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor15, []int{0} }
...
func (*CedeActiveResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor15, []int{1} }
...
func (*GracefulFailoverRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor15, []int{2} }
...
func (*GracefulFailoverResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor15, []int{3} }
...
func init() { proto.RegisterFile("ZKFCProtocol.proto", fileDescriptor15) }
