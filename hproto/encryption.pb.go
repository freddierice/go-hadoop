...
func (*ListEncryptionZonesRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{2} }
...
func (*EncryptionZoneProto) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{3} }
...
func (*GetEZForPathRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{5} }
...
func (*GetEZForPathResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{6} }
...
func init() { proto.RegisterFile("encryption.proto", fileDescriptor8) }
