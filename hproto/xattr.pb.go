...
func (XAttrSetFlagProto) EnumDescriptor() ([]byte, []int) { return fileDescriptor32, []int{0} }
...
func (XAttrProto_XAttrNamespaceProto) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor32, []int{0, 0}
}
...
func (*XAttrProto) Descriptor() ([]byte, []int) { return fileDescriptor32, []int{0} }
...
func (*SetXAttrRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor32, []int{1} }
...
func (*SetXAttrResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor32, []int{2} }
...
func (*GetXAttrsRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor32, []int{3} }
...
func (*GetXAttrsResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor32, []int{4} }
...
func (*ListXAttrsRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor32, []int{5} }
...
func (*ListXAttrsResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor32, []int{6} }
...
func (*RemoveXAttrRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor32, []int{7} }
...
func (*RemoveXAttrResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor32, []int{8} }
...
func init() { proto.RegisterFile("xattr.proto", fileDescriptor32) }
