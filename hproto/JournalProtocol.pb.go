...
func (*JournalInfoProto) Descriptor() ([]byte, []int) { return fileDescriptor20, []int{0} }
...
func (*JournalRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor20, []int{1} }
...
func (*JournalResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor20, []int{2} }
...
func (*StartLogSegmentRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor20, []int{3} }
...
func (*StartLogSegmentResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor20, []int{4} }
...
func (*FenceRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor20, []int{5} }
...
func (*FenceResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor20, []int{6} }
...
func init() { proto.RegisterFile("JournalProtocol.proto", fileDescriptor20) }
