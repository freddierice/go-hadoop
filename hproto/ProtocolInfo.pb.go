...
func (*GetProtocolVersionsRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{0} }
...
func (*ProtocolVersionProto) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{1} }
...
func (*ProtocolSignatureProto) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{5} }
...
func init() { proto.RegisterFile("ProtocolInfo.proto", fileDescriptor8) }
