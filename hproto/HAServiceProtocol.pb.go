...
func (HAServiceStateProto) EnumDescriptor() ([]byte, []int) { return fileDescriptor3, []int{0} }
...
func (HARequestSource) EnumDescriptor() ([]byte, []int) { return fileDescriptor3, []int{1} }
...
func (*HAStateChangeRequestInfoProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{0} }
...
func (*MonitorHealthRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{1} }
...
func (*MonitorHealthResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{2} }
...
func (*TransitionToActiveRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{3} }
...
func (*TransitionToActiveResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{4} }
...
func (*TransitionToStandbyRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{5} }
...
func (*GetServiceStatusRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{7} }
...
func (*GetServiceStatusResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{8} }
...
func init() { proto.RegisterFile("HAServiceProtocol.proto", fileDescriptor3) }
