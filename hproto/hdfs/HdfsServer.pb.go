...
type BlockWithLocationsProto struct {
	...
	StorageTypes     []hadoop_hdfs.StorageTypeProto `protobuf:"varint,4,rep,name=storageTypes,enum=hadoop.hdfs.StorageTypeProto" json:"storageTypes,omitempty"`
...
func (m *BlockWithLocationsProto) GetStorageTypes() []hadoop_hdfs.StorageTypeProto {
	if m != nil {
...
type RecoveringBlockProto struct {
	...
	Block         *hadoop_hdfs.LocatedBlockProto        `protobuf:"bytes,2,req,name=block" json:"block,omitempty"`
	TruncateBlock *hadoop_hdfs.BlockProto               `protobuf:"bytes,3,opt,name=truncateBlock" json:"truncateBlock,omitempty"`
	EcPolicy      *hadoop_hdfs.ErasureCodingPolicyProto `protobuf:"bytes,4,opt,name=ecPolicy" json:"ecPolicy,omitempty"`
...
func (m *RecoveringBlockProto) GetBlock() *hadoop_hdfs.LocatedBlockProto {
	if m != nil {
		return m.Block
	}
	return nil
...
func (m *RecoveringBlockProto) GetTruncateBlock() *hadoop_hdfs.BlockProto {
	if m != nil {
...
func (m *RecoveringBlockProto) GetEcPolicy() *hadoop_hdfs.ErasureCodingPolicyProto {
	if m != nil {
		return m.EcPolicy
	}
	return nil
